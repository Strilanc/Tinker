...
#End Region
    ...
    Public Sub ItemCountPrefixedFramingJarTest()
        ...
        JarTest(jar, equater, New UShort() {}.ToRist, {0})
        JarTest(jar, equater, New UShort() {0}.ToRist, {1, 0, 0})
        JarTest(jar, equater, New UShort() {1}.ToRist, {1, 1, 0})
        JarTest(jar, equater, New UShort() {1, 2, UInt16.MaxValue}.ToRist, {3, 1, 0, 2, 0, &HFF, &HFF})
        ExpectException(Of PicklingException)(Sub() jar.Parse(New Byte() {}.AsRist))
        ExpectException(Of PicklingException)(Sub() jar.Parse(New Byte() {1}.AsRist))

        jar = New ItemCountPrefixedFramingJar(Of UInt16)(New UInt16Jar(), prefixSize:=4)
        JarTest(jar, equater, New UShort() {}.ToRist, {0, 0, 0, 0})
        JarTest(jar, equater, New UShort() {0}.ToRist, {1, 0, 0, 0, 0, 0})
        JarTest(jar, equater, New UShort() {1}.ToRist, {1, 0, 0, 0, 1, 0})
        JarTest(jar, equater, New UShort() {1, 2, UInt16.MaxValue}.ToRist, {3, 0, 0, 0, 1, 0, 2, 0, &HFF, &HFF})
        ExpectException(Of PicklingException)(Sub() jar.Parse(New Byte() {}.AsRist))
