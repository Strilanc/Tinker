...
#Region "Inner"
        ...
        Private NotInheritable Class AdvertisingLinkMember
            ...
            Private ReadOnly games As New HashSet(Of GameDescription)
            ...
            Private Event AddedGame(ByVal sender As IGameSource, ByVal game As GameDescription, ByVal server As GameServer) Implements IGameSource.AddedGame
            Private Event RemovedGame(ByVal sender As IGameSource, ByVal game As GameDescription, ByVal reason As String) Implements IGameSource.RemovedGame
            ...
            Public Sub AddGame(ByVal game As GameDescription, ByVal server As GameServer) Implements IGameSourceSink.AddGame
                ...
                End If
            End Sub
            Public Sub RemoveGame(ByVal game As GameDescription, ByVal reason As String) Implements IGameSourceSink.RemoveGame
...
#Region "State"
        ...
        Public Function RemoveGame(ByVal id As UInteger) As Boolean
            ...
            SyncLock lock
                ...
                'Notify
                Dim pk = Packet.MakeLanDestroyGame(id)
...
#Region "Networking"
        ...
        Public Sub Refresh() Handles refreshTimer.Elapsed
            SyncLock lock
                For Each game In games1
                    Dim pk = Packet.MakeLanDescribeGame(
                                    game.creation_time,
        ...
        Private Sub send(ByVal pk As Packet, ByVal remote_host As String, ByVal remote_port As UShort)
            Try
                'pack
